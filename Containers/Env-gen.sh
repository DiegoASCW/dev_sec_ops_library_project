...
# Reset do ambiente
docker stop ubuntu_apache mysql-stable > /dev/null
docker rm ubuntu_apache mysql-stable > /dev/null
...
docker network connect --ip 10.0.45.10 apache_mysql_network-R4-5 mysql-stable
