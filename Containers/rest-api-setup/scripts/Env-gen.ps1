...
docker stop register_list_auth_api ubuntu_apache mysql_stable debian_api_gateway micro-auth-api micro_auth_api micro_list_reg_books_api *> $null

docker rmi register-list-auth_openshelf_image debian_api_gateway_openshelf_image micro-auth_openshelf_image mysql_stable_image apache_openshelf_image -f *> $null

docker rm register_list_auth_api ubuntu_apache mysql_stable debian_api_gateway micro-auth-api micro_auth_api micro_list_reg_books_api *> $null  

docker network rm apache_network-R5 mysql_network-R4 `
  apache_mysql_network-R4-5 apache_mysql_network-R45 openshelf_mysql_network-R4 `
...
Write-Host "`nNetwork 'apache_mysql_network-R45' (ip-range: 10.0.45.0/24): " -ForegroundColor Blue -NoNewline
...
Write-Host "`nNetwork 'micro_register_list_auth_mysql_network-R10034' (10.100.34.0/24): " -ForegroundColor Blue -NoNewline
